...
There is also a folder _cross_ with results of the experiment *cross_gc* and *cross_thome* with cross-identifications between old catalogs (Catálogos Argentinos, Oeltzen-Argelander, Lalande, Lacaille, USNO, Taylor) and PPM/CD/CPD.
